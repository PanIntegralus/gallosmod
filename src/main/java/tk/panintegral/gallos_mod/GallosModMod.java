 ...
 *
 *    Keep the ElementsGallosModMod object in this class and all calls to this object
...
public class GallosModMod {
	...
	@Mod.Instance(MODID)
	public static GallosModMod instance;
	public ElementsGallosModMod elements = new ElementsGallosModMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsGallosModMod.GuiHandler());
